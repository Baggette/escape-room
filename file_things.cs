...
namespace file_thing
{
    public class file_stuff
    {
        ...
        public string writeToFileAndHash(string content)
        {
            string random_path = "";
            string go_lower = "";
            ...
            while(true)
            {
                try
                {
                    ...
                    {
                        using (StreamWriter outputFile = new StreamWriter(Path.Combine(go_lower, "sus.txt"), true))
                        {
            ...
            return HashFile(go_lower + "/sus.txt");
        }
